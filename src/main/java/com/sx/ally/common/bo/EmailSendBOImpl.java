...
public class EmailSendBOImpl implements EmailSendBO {
	...
	public boolean sendCertificationEmail(Map<String, Object> paramMap) {
		...
		String message = "<p><span style='color: rgb(99, 99, 99);'>안녕하세요.</span></p><p><br></p>"
				...
				+ "<a href='http://125.209.240.10:10003/ally/member/certificationMember?certificationCode=" + crtCode + "&emailAddress=" + recipientAddress + "&ageGroup=" + ageGroup + "&sex=" + sex + "&companyNo=" + companyNo +"' target='_self' style='cursor: pointer; white-space: pre;'>[이메일 인증]</a>"
