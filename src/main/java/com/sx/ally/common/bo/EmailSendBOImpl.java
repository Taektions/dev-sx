...
public class EmailSendBOImpl implements EmailSendBO {
	...
	public boolean sendCertificationEmail(Map<String, Object> paramMap) {
		...
		String message = "<p><span style='color: rgb(99, 99, 99);'>안녕하세요.</span></p><p><br></p>"
				...
				+ "<a href='http://10.113.216.132:9001/ally/member/certificationMember?certificationCode=" + crtCode + "&emailAddress=" + recipientAddress + "&ageGroup=" + ageGroup + "&sex=" + sex + "&companyNo=" + companyNo +"' target='_self' style='cursor: pointer; white-space: pre;'>[이메일 인증]</a>"
